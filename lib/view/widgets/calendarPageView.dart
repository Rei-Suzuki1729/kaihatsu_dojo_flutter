...
import 'package:kaihatsu_dojo_flutter/model/viewmodel/calendarmodel.dart';
import 'package:kaihatsu_dojo_flutter/objects/record.dart';
import 'package:kaihatsu_dojo_flutter/view/recordPage.dart';
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Container(
                            child: Column(
                              children: [
                                Text('Condition', style: kWhiteTextStyle),
                                Row(
                                  mainAxisAlignment: MainAxisAlignment.center,
                                  crossAxisAlignment: CrossAxisAlignment.end,
                                  children: [
                                    Text(recordDataList[index].Condition!,
                          ...
                          Container(
                            child: Column(
                              children: [
                                Text('DiffCondition', style: kWhiteTextStyle),
                                Row(
                                  mainAxisAlignment: MainAxisAlignment.center,
                                  children: [
                                    Text(recordDataList[index].DiffCondition!,
                                        style: kNumberTextStyle),
                                  ],
                                ),
                              ],
